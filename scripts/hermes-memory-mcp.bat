@echo off
rem hermes-memory-mcp.bat — Hermès brain MCP launcher (separate data dir)
...
rem Hermès brain data (separate from OpenClaw's ~/.duck-memory/)
set "DUCK_MEM_DIR=%USERPROFILE%\.duckbot-hermes"
