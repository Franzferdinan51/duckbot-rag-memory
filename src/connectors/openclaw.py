...
TOOL_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "skip_scan": {"type": "boolean", "default": True, "description": "skip injection scan (use only for trusted callers)"},
            },
            "required": ["text"],
        },
    },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "tier": {"type": "string", "enum": ["working", "episodic", "semantic", "procedural"]},
                "min_importance": {"type": "number"},
                "rerank": {"type": "boolean", "default": True, "description": "Layer 7: run cross-encoder rerank (qwen3-reranker-0.6b). Default on; pass false to disable. No paid API."},
                "decay": {"type": "boolean", "default": True, "description": "Layer 8: apply Ebbinghaus retention weighting. Default on; pass false to disable. Public-domain math (1885), no LLM call. Boosts recently-recalled chunks."},
                "tier_priors": {"type": "boolean", "default": True, "description": "Layer 11: apply per-tier multiplicative priors (procedural=1.5, semantic=1.2, episodic=1.0, working=0.8). Default on; pass false to disable. Boosts procedural rules and demotes working chatter."},
                ...
                "fsrs": {"type": "boolean", "default": True, "description": "Layer 9: apply FSRS-6 power-law retrievability weighting. Default on; pass false to disable. Uses per-chunk stability_days + difficulty from metadata. Public-domain algorithm spec."},
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "force": {"type": "boolean", "default": True, "description": "re-store even if already present"},
            },
        },
    },
