    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "tier_priors": {"type": "boolean", "default": True, "description": "Layer 11: apply per-tier multiplicative weights (procedural=1.5, semantic=1.2, episodic=1.0, working=0.8)"},
                "tier_priors_overrides": {"type": "object", "description": "per-tier weight overrides, e.g. {\"procedural\": 2.0}"},
                "fsrs": {"type": "boolean", "default": True, "description": "Layer 9: use FSRS-6 power-law forgetting instead of Ebbinghaus"},
            },
            "required": ["query"],
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "rerank": {"type": "boolean", "default": True},
                "decay": {"type": "boolean", "default": True},
                "tier_priors": {"type": "boolean", "default": True},
                "tier_priors_overrides": {"type": "object"},
                "fsrs": {"type": "boolean", "default": True},
            },
            "required": ["query"],
        },
    },
